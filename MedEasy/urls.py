...
"""
Defining the swagger schema view.
Necessary information is passed to the schema view through openapi info method.
"""
...
"""
Handling the static and media behaviour.
Media will contain the application's data like image, pdf file that user will upload.
Static will handle the asset of the project like css, js, fonts, etc.
"""
